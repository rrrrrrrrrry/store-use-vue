    ...
    <div>
      ...
      <div class="params-colors">
        <ul class="colors-list">
          <li key="index" v-for="sku,index in item.sku_info"><!--点击下标图片更改-->
      ...
      <div class="item-btns clearfix">
        ...
        <span @click="addCarPanelHandle(item.sku_info[itemIndex])" class="item-blue-btn">加入购物车 </span><!--加入购物车上添加处理函数-->
      </div>
